...
public class MetadataInfo {
    ...
    @XmlElementRef(name = "chord", namespace = "http://dalbum_child.model.product.nbc.sitech.com/xsd", type = JAXBElement.class)
    protected JAXBElement<String> chord;
    @XmlElementRef(name = "cmpUrl", namespace = "http://dalbum_child.model.product.nbc.sitech.com/xsd", type = JAXBElement.class)
    protected JAXBElement<String> cmpUrl;
    @XmlElementRef(name = "fileType", namespace = "http://dalbum_child.model.product.nbc.sitech.com/xsd", type = JAXBElement.class)
    protected JAXBElement<String> fileType;
    @XmlElementRef(name = "isGet", namespace = "http://dalbum_child.model.product.nbc.sitech.com/xsd", type = JAXBElement.class)
    protected JAXBElement<String> isGet;
    @XmlElementRef(name = "mimeType", namespace = "http://dalbum_child.model.product.nbc.sitech.com/xsd", type = JAXBElement.class)
    protected JAXBElement<String> mimeType;
    @XmlElementRef(name = "resourceID", namespace = "http://dalbum_child.model.product.nbc.sitech.com/xsd", type = JAXBElement.class)
    protected JAXBElement<String> resourceID;
    @XmlElementRef(name = "size", namespace = "http://dalbum_child.model.product.nbc.sitech.com/xsd", type = JAXBElement.class)
    protected JAXBElement<String> size;
    @XmlElementRef(name = "terminalList", namespace = "http://dalbum_child.model.product.nbc.sitech.com/xsd", type = JAXBElement.class)
